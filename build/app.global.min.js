...
this["Handlebars"]["templates"]["substitution"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var helper;
...
var mainApp={data:{}};(function(){var that=mainApp.data,data='{ "comics": [ { "url":"https://xkcd.com/1704/", "translations":[ { "find":"no man", "replace":"Gnome Ann" } ] } ]}';this.getRawData=function(){return data},this.getFormattedData=function(){var rawData=JSON.parse(that.getRawData()),translations=[];return rawData.comics.forEach(function(comic){translations=translations.concat(comic.translations)}),translations}}).apply(mainApp.data);
//# sourceMappingURL=app.global.min.js.map